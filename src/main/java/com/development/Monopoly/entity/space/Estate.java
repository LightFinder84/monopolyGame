...
public class Estate extends Property {
    ...
    public int calculateRentMoney() {
        if (this.id == 1) {
            if (this.getNumberOfBuildings() == 0)
                return 2;
            else if (this.getNumberOfBuildings() == 1)
                return 10;
    ...
    public int getSellPrice() {
        int priceForEstateAndAllBuildings = this.getPriceForBuilding() * this.getNumberOfBuildings() / 2
                + this.getPriceForProperty() / 2;
    ...
    public void deleteABuilding() {
        if (numberOfHousesCanBeBuild <= 0)
            throw new UnExpectedErrorException("Không còn nhà để bán");
        else {
            numberOfBuildings--;
            numberOfHousesCanBeBuild++;
        }
    ...
    public String getInfo() {
        ...
        String ownerRow = "<div class=\"row\"><div class=\"col\">Chủ:</div><div class=\"col\">" + ownerName
                + "</div></div>";
        String houseRow = "<div class=\"row\"><div class=\"col\">Số nhà đã xây:</div><div class=\"col\">"
                + this.numberOfBuildings + "</div></div>";
